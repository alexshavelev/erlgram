...
-asn1_info([{vsn,'4.0.1'},
 ...
 {cwd,"/net/isildur/ldisk/daily_build/18_prebuild_opu_o.2015-12-15_21/otp_src_18/lib/public_key/asn1"},
 {outdir,"/net/isildur/ldisk/daily_build/18_prebuild_opu_o.2015-12-15_21/otp_src_18/lib/public_key/asn1"},
 asn1config,noobj,der,
 {i,"."},
 {i,"/net/isildur/ldisk/daily_build/18_prebuild_opu_o.2015-12-15_21/otp_src_18/lib/public_key/asn1"}]}]).
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case is_default_3(Cindex4) of
true -> {[],0};
false ->
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case is_default_7(Cindex5) of
true -> {[],0};
false ->
...
%%-------------------------------------------------
   {EncBytes6,EncLen6} =  case is_default_8(Cindex6) of
true -> {[],0};
false ->
...
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case is_default_10(Cindex1) of
true -> {[],0};
false ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_13'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
DecObjalgorithmTerm1 =
   'OTP-PUB-KEY':'getdec_internal_object_set_argument_10'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case is_default_11(Cindex1) of
true -> {[],0};
false ->
