...
%% Source: /net/isildur/ldisk/daily_build/18_prebuild_opu_o.2015-12-15_21/otp_src_18/lib/cosTransactions/src/CosTransactions.idl
%% IC vsn: 4.4
%% 
...
oe_register() ->
    ...
    orber_ifr:'ModuleDef_create_enum'(_OE_1, "IDL:omg.org/CosTransactions/Status:1.0", "Status", "1.0", ["StatusActive","StatusMarkedRollback","StatusPrepared","StatusCommitted",
   "StatusRolledBack","StatusUnknown","StatusNoTransaction","StatusPreparing",
   "StatusCommitting","StatusRollingBack"]),
