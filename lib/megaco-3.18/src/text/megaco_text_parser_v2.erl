...
-file("megaco_text_parser_v2.erl", 187).
...
-dialyzer({nowarn_function, yeccpars2_818/7}).
...
-dialyzer({nowarn_function, yeccpars2_878/7}).
yeccpars2_878(S, 'CtxToken', Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 749, Ss, Stack, T, Ts, Tzr);
yeccpars2_878(_, _, _, _, T, _, _) ->
 yeccerror(T).
