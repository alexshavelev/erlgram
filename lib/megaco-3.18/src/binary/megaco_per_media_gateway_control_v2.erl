%% Generated by the Erlang ASN.1 PER-compiler version, utilizing bit-syntax:4.0.1
...
Enc8@bitmap = extension_bitmap(Val, 11, 12),
...
begin
Enc4@element = element(2, Val),
enc_IndAudTerminationStateDescriptor_propertyParms(Enc4@element)
end,
begin
Enc5@element = element(3, Val),
if Enc5@element =:= asn1_NOVALUE ->
...
[];
true ->
enc_IndAudLocalControlDescriptor_propertyParms(Enc12@element)
end
end].
...
[];
true ->
enc_IndAudLocalControlDescriptor(Enc5@element)
end
end,
begin
Enc7@element = element(3, Val),
...
[];
true ->
enc_IndAudLocalRemoteDescriptor(Enc7@element)
end
end|begin
Enc9@element = element(4, Val),
if Enc9@element =:= asn1_NOVALUE ->
[];
true ->
enc_IndAudLocalRemoteDescriptor(Enc9@element)
end
end].
...
7 -> v91;
8 -> synchISDN;
_ -> exit({error,{asn1,{decode_enumerated,{V4@V3,[v18,v22,v22bis,v32,v32bis,v34,v90,v91,synchISDN]}}}})
end,
{V4@Int5,V4@Buf4};
<<1:1,V4@Buf2/bitstring>> ->
{V4@V3,V4@Buf4} = case V4@Buf2 of
