...
%%-------------------------------------------------
%% attribute nonStandardIdentifier(1)   External megaco_ber_media_gateway_control_prev3a:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute statValue(2)   External megaco_ber_media_gateway_control_prev3a:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(1)   External megaco_ber_media_gateway_control_prev3a:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeAddress(2)   External megaco_ber_media_gateway_control_prev3a:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute serviceChangeProfile(4)   External megaco_ber_media_gateway_control_prev3a:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timestamp(5)   External megaco_ber_media_gateway_control_prev3a:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeReason(5)   External megaco_ber_media_gateway_control_prev3a:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(7)   External megaco_ber_media_gateway_control_prev3a:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeStamp(8)   External megaco_ber_media_gateway_control_prev3a:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute nonStandardData(9)   External megaco_ber_media_gateway_control_prev3a:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeInfo(10)   External megaco_ber_media_gateway_control_prev3a:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute digitMapValue(2)   External megaco_ber_media_gateway_control_prev3a:DigitMapValue OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute nonStandardData(3)   External megaco_ber_media_gateway_control_prev3a:NonStandardData OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute value(2)   External megaco_ber_media_gateway_control_prev3a:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute eventDM(2)   External megaco_ber_media_gateway_control_prev3a:EventDM OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(3)   External megaco_ber_media_gateway_control_prev3a:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3a:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(3)   External megaco_ber_media_gateway_control_prev3a:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(4)   External megaco_ber_media_gateway_control_prev3a:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3a:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3a:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3a:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3a:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3a:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3a:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3a:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute serviceChangeResult(2)   External megaco_ber_media_gateway_control_prev3a:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeParms(2)   External megaco_ber_media_gateway_control_prev3a:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeNotation(4)   External megaco_ber_media_gateway_control_prev3a:TimeNotation OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute errorDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute observedEventsDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute errorDescriptor(3)   External megaco_ber_media_gateway_control_prev3a:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalList(2)   External megaco_ber_media_gateway_control_prev3a:IndAudSignal OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute propGrps(2)   External megaco_ber_media_gateway_control_prev3a:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3a:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3a:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3a:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3a:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3a:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3a:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationAuditResult(2)   External megaco_ber_media_gateway_control_prev3a:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:AuditDescriptor
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3a:AuditDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationAudit(2)   External megaco_ber_media_gateway_control_prev3a:TerminationAudit OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationFrom(1)   External megaco_ber_media_gateway_control_prev3a:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationTo(2)   External megaco_ber_media_gateway_control_prev3a:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute command(1)   External megaco_ber_media_gateway_control_prev3a:Command
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute contextReply(3)   External megaco_ber_media_gateway_control_prev3a:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextRequest(2)   External megaco_ber_media_gateway_control_prev3a:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextAttrAuditReq(3)   External megaco_ber_media_gateway_control_prev3a:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mId(2)   External megaco_ber_media_gateway_control_prev3a:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute authHeader(1)   External megaco_ber_media_gateway_control_prev3a:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mess(2)   External megaco_ber_media_gateway_control_prev3a:Message
%%-------------------------------------------------
