...
%% Purpose: encoder and decoder to the types in mod megaco_ber_media_gateway_control_prev3c

-module('megaco_ber_media_gateway_control_prev3c').
-compile(nowarn_unused_vars).
-include("megaco_ber_media_gateway_control_prev3c.hrl").
-asn1_info([{vsn,'4.0.1'},
            {module,'megaco_ber_media_gateway_control_prev3c'},
...
%%-------------------------------------------------
%% attribute nonStandardIdentifier(1)   External megaco_ber_media_gateway_control_prev3c:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute statValue(2)   External megaco_ber_media_gateway_control_prev3c:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(1)   External megaco_ber_media_gateway_control_prev3c:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeAddress(2)   External megaco_ber_media_gateway_control_prev3c:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute serviceChangeProfile(4)   External megaco_ber_media_gateway_control_prev3c:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timestamp(5)   External megaco_ber_media_gateway_control_prev3c:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeReason(5)   External megaco_ber_media_gateway_control_prev3c:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(7)   External megaco_ber_media_gateway_control_prev3c:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeStamp(8)   External megaco_ber_media_gateway_control_prev3c:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute nonStandardData(9)   External megaco_ber_media_gateway_control_prev3c:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeInfo(10)   External megaco_ber_media_gateway_control_prev3c:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute digitMapValue(2)   External megaco_ber_media_gateway_control_prev3c:DigitMapValue OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute nonStandardData(3)   External megaco_ber_media_gateway_control_prev3c:NonStandardData OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute value(2)   External megaco_ber_media_gateway_control_prev3c:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute eventDM(2)   External megaco_ber_media_gateway_control_prev3c:EventDM OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(3)   External megaco_ber_media_gateway_control_prev3c:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute notifyBehaviour(4)   External megaco_ber_media_gateway_control_prev3c:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3c:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(3)   External megaco_ber_media_gateway_control_prev3c:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(4)   External megaco_ber_media_gateway_control_prev3c:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute notifyBehaviour(5)   External megaco_ber_media_gateway_control_prev3c:NotifyBehaviour OPTIONAL
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case Cindex5 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(1)   External megaco_ber_media_gateway_control_prev3c:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3c:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3c:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3c:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3c:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3c:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3c:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3c:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute serviceChangeResult(2)   External megaco_ber_media_gateway_control_prev3c:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeParms(2)   External megaco_ber_media_gateway_control_prev3c:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeNotation(4)   External megaco_ber_media_gateway_control_prev3c:TimeNotation OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute errorDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute observedEventsDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute errorDescriptor(3)   External megaco_ber_media_gateway_control_prev3c:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalList(2)   External megaco_ber_media_gateway_control_prev3c:IndAudSignal OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute propGrps(2)   External megaco_ber_media_gateway_control_prev3c:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute propertyParms(2)   External megaco_ber_media_gateway_control_prev3c:PropertyParm OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3c:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3c:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3c:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3c:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3c:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationIDList(1)   External megaco_ber_media_gateway_control_prev3c:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationAuditResult(2)   External megaco_ber_media_gateway_control_prev3c:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3c:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:AuditDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_AuditDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute terminationIDList(3)   External megaco_ber_media_gateway_control_prev3c:TerminationIDList OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3c:AuditDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationAudit(2)   External megaco_ber_media_gateway_control_prev3c:TerminationAudit OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationFrom(1)   External megaco_ber_media_gateway_control_prev3c:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationTo(2)   External megaco_ber_media_gateway_control_prev3c:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute command(1)   External megaco_ber_media_gateway_control_prev3c:Command
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute selectLogic(9)   External megaco_ber_media_gateway_control_prev3c:SelectLogic OPTIONAL
%%-------------------------------------------------
   {EncBytes9,EncLen9} =  case Cindex9 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextReply(3)   External megaco_ber_media_gateway_control_prev3c:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextRequest(2)   External megaco_ber_media_gateway_control_prev3c:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextAttrAuditReq(3)   External megaco_ber_media_gateway_control_prev3c:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mId(2)   External megaco_ber_media_gateway_control_prev3c:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute authHeader(1)   External megaco_ber_media_gateway_control_prev3c:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mess(2)   External megaco_ber_media_gateway_control_prev3c:Message
%%-------------------------------------------------
