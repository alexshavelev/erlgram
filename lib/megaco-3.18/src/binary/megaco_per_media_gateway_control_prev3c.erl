...
%% Purpose: encoder and decoder to the types in mod megaco_per_media_gateway_control_prev3c

-module('megaco_per_media_gateway_control_prev3c').
-compile(nowarn_unused_vars).
-include("megaco_per_media_gateway_control_prev3c.hrl").
-asn1_info([{vsn,'4.0.1'},
            {module,'megaco_per_media_gateway_control_prev3c'},
...
1 -> outOfSvc;
2 -> inSvc;
_ -> exit({error,{asn1,{decode_enumerated,{V7@V3,[test,outOfSvc,inSvc]}}}})
end,
{V7@Int5,V7@Buf4};
<<1:1,V7@Buf2/bitstring>> ->
{V7@V3,V7@Buf4} = case V7@Buf2 of
...
3 -> inactive;
4 -> loopBack;
_ -> exit({error,{asn1,{decode_enumerated,{V8@V3,[sendOnly,recvOnly,sendRecv,inactive,loopBack]}}}})
end,
{V8@Int5,V8@Buf4};
