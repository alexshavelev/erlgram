...
case Tlv10 of [] -> true; _ -> true end, % ... extra fields skipped
   {'ServiceChangeParm', Term1, Term2, Term3, Term4, Term5, Term6, Term7, Term8, Term9}.
...
case Tlv5 of [] -> true; _ -> true end, % ... extra fields skipped
   {'DigitMapValue', Term1, Term2, Term3, Term4}.
...
[] -> true;_ -> exit({error,{asn1, {unexpected,Tlv4}}}) % extra fields not allowed
   ...
   {'TopologyRequest', Term1, Term2, Term3}.
