...
%% Purpose: encoder and decoder to the types in mod megaco_ber_media_gateway_control_prev3b

-module('megaco_ber_media_gateway_control_prev3b').
-compile(nowarn_unused_vars).
-include("megaco_ber_media_gateway_control_prev3b.hrl").
-asn1_info([{vsn,'4.0.1'},
            {module,'megaco_ber_media_gateway_control_prev3b'},
...
%%-------------------------------------------------
%% attribute nonStandardIdentifier(1)   External megaco_ber_media_gateway_control_prev3b:NonStandardIdentifier
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute statValue(2)   External megaco_ber_media_gateway_control_prev3b:Value OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(1)   External megaco_ber_media_gateway_control_prev3b:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeAddress(2)   External megaco_ber_media_gateway_control_prev3b:ServiceChangeAddress OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute serviceChangeProfile(4)   External megaco_ber_media_gateway_control_prev3b:ServiceChangeProfile OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timestamp(5)   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeReason(5)   External megaco_ber_media_gateway_control_prev3b:Value
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeMgcId(7)   External megaco_ber_media_gateway_control_prev3b:MId OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeStamp(8)   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute nonStandardData(9)   External megaco_ber_media_gateway_control_prev3b:NonStandardData OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeInfo(10)   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute digitMapValue(2)   External megaco_ber_media_gateway_control_prev3b:DigitMapValue OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute nonStandardData(3)   External megaco_ber_media_gateway_control_prev3b:NonStandardData OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute value(2)   External megaco_ber_media_gateway_control_prev3b:Value
%%-------------------------------------------------
...
case Tlv10 of [] -> true; _ -> true end, % ... extra fields skipped
   {'Signal', Term1, Term2, Term3, Term4, Term5, Term6, Term7, Term8, Term9}.
...
%%-------------------------------------------------
%% attribute eventDM(2)   External megaco_ber_media_gateway_control_prev3b:EventDM OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(3)   External megaco_ber_media_gateway_control_prev3b:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3b:SecondRequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute secondEvent(3)   External megaco_ber_media_gateway_control_prev3b:SecondEventsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalsDescriptor(4)   External megaco_ber_media_gateway_control_prev3b:SignalsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute eventAction(3)   External megaco_ber_media_gateway_control_prev3b:RequestedActions OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3b:LocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3b:LocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3b:StatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3b:StreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3b:TerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3b:TerminationIDList
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationIDList'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute serviceChangeResult(2)   External megaco_ber_media_gateway_control_prev3b:ServiceChangeResult
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute serviceChangeParms(2)   External megaco_ber_media_gateway_control_prev3b:ServiceChangeParm
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute timeNotation(4)   External megaco_ber_media_gateway_control_prev3b:TimeNotation OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute errorDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute observedEventsDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:ObservedEventsDescriptor
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_ObservedEventsDescriptor'(Cindex2, [<<161>>]),

%%-------------------------------------------------
%% attribute errorDescriptor(3)   External megaco_ber_media_gateway_control_prev3b:ErrorDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute signalList(2)   External megaco_ber_media_gateway_control_prev3b:IndAudSignal OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute propGrps(2)   External megaco_ber_media_gateway_control_prev3b:IndAudPropertyGroup
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute localControlDescriptor(1)   External megaco_ber_media_gateway_control_prev3b:IndAudLocalControlDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute localDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute remoteDescriptor(3)   External megaco_ber_media_gateway_control_prev3b:IndAudLocalRemoteDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute statisticsDescriptor(4)   External megaco_ber_media_gateway_control_prev3b:IndAudStatisticsDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute streamParms(2)   External megaco_ber_media_gateway_control_prev3b:IndAudStreamParms
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute termStateDescr(1)   External megaco_ber_media_gateway_control_prev3b:IndAudTerminationStateDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationID(1)   External megaco_ber_media_gateway_control_prev3b:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationAuditResult(2)   External megaco_ber_media_gateway_control_prev3b:TerminationAudit
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute auditDescriptor(2)   External megaco_ber_media_gateway_control_prev3b:AuditDescriptor OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationAudit(2)   External megaco_ber_media_gateway_control_prev3b:TerminationAudit OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute terminationFrom(1)   External megaco_ber_media_gateway_control_prev3b:TerminationID
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_TerminationID'(Cindex1, [<<160>>]),

%%-------------------------------------------------
%% attribute terminationTo(2)   External megaco_ber_media_gateway_control_prev3b:TerminationID
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute command(1)   External megaco_ber_media_gateway_control_prev3b:Command
%%-------------------------------------------------
...
case Tlv6 of [] -> true; _ -> true end, % ... extra fields skipped
   {'ContextAttrAuditRequest', Term1, Term2, Term3, Term4, Term5}.
...
case Tlv6 of [] -> true; _ -> true end, % ... extra fields skipped
   {'ContextRequest', Term1, Term2, Term3, Term4, Term5}.
...
%%-------------------------------------------------
%% attribute contextReply(3)   External megaco_ber_media_gateway_control_prev3b:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextRequest(2)   External megaco_ber_media_gateway_control_prev3b:ContextRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute contextAttrAuditReq(3)   External megaco_ber_media_gateway_control_prev3b:ContextAttrAuditRequest OPTIONAL
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mId(2)   External megaco_ber_media_gateway_control_prev3b:MId
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute authHeader(1)   External megaco_ber_media_gateway_control_prev3b:AuthenticationHeader OPTIONAL
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
...
%%-------------------------------------------------
%% attribute mess(2)   External megaco_ber_media_gateway_control_prev3b:Message
%%-------------------------------------------------
