...
-module('CosNotifyChannelAdmin_StructuredProxyPullConsumer').
-ic_compiled("4_4").


%% Interface functions
-export([connect_structured_pull_supplier/2, connect_structured_pull_supplier/3, suspend_connection/1]).
...
-export([disconnect_structured_pull_consumer/1, disconnect_structured_pull_consumer/2]).
...
%%
connect_structured_pull_supplier(OE_THIS, Pull_supplier) ->
    corba:call(OE_THIS, connect_structured_pull_supplier, [Pull_supplier], ?MODULE).

connect_structured_pull_supplier(OE_THIS, OE_Options, Pull_supplier) ->
    corba:call(OE_THIS, connect_structured_pull_supplier, [Pull_supplier], ?MODULE, OE_Options).
...
%%%% Operation: disconnect_structured_pull_consumer
%% 
%%   Returns: RetVal
%%
disconnect_structured_pull_consumer(OE_THIS) ->
    corba:call(OE_THIS, disconnect_structured_pull_consumer, [], ?MODULE).

disconnect_structured_pull_consumer(OE_THIS, OE_Options) ->
    corba:call(OE_THIS, disconnect_structured_pull_consumer, [], ?MODULE, OE_Options).
...
%%
%%------------------------------------------------------------
oe_is_a("IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0") -> true;
...
oe_is_a("IDL:omg.org/CosNotifyComm/StructuredPullConsumer:1.0") -> true;
...
oe_tc(connect_structured_pull_supplier) -> 
	{tk_void,[{tk_objref,"IDL:omg.org/CosNotifyComm/StructuredPullSupplier:1.0",
...
oe_tc(disconnect_structured_pull_consumer) -> 'CosNotifyComm_StructuredPullConsumer':oe_tc(disconnect_structured_pull_consumer);
...
oe_get_interface() -> 
	...
	{"disconnect_structured_pull_consumer", 'CosNotifyComm_StructuredPullConsumer':oe_tc(disconnect_structured_pull_consumer)},
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullConsumer:1.0", Env, RegName).
...
%%   Raises:  CosEventChannelAdmin::AlreadyConnected, CosEventChannelAdmin::TypeError
%%
handle_call({OE_THIS, OE_Context, connect_structured_pull_supplier, [Pull_supplier]}, OE_From, OE_State) ->
  corba:handle_call('PullerConsumer_impl', connect_structured_pull_supplier, [Pull_supplier], OE_State, OE_Context, OE_THIS, OE_From);
...
%%   Returns: RetVal
%%
handle_call({OE_THIS, OE_Context, disconnect_structured_pull_consumer, []}, OE_From, OE_State) ->
  corba:handle_call('PullerConsumer_impl', disconnect_structured_pull_consumer, [], OE_State, OE_Context, OE_THIS, OE_From);
