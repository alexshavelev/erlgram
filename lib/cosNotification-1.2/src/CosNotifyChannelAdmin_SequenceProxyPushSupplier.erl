...
-module('CosNotifyChannelAdmin_SequenceProxyPushSupplier').
-ic_compiled("4_4").


%% Interface functions
-export([connect_sequence_push_consumer/2, connect_sequence_push_consumer/3, suspend_connection/1]).
...
%%
connect_sequence_push_consumer(OE_THIS, Push_consumer) ->
    corba:call(OE_THIS, connect_sequence_push_consumer, [Push_consumer], ?MODULE).

connect_sequence_push_consumer(OE_THIS, OE_Options, Push_consumer) ->
    corba:call(OE_THIS, connect_sequence_push_consumer, [Push_consumer], ?MODULE, OE_Options).
...
%%
%%------------------------------------------------------------
oe_is_a("IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0") -> true;
...
oe_tc(connect_sequence_push_consumer) -> 
	{tk_void,[{tk_objref,"IDL:omg.org/CosNotifyComm/SequencePushConsumer:1.0",
...
oe_tc(disconnect_sequence_push_supplier) -> 'CosNotifyComm_SequencePushSupplier':oe_tc(disconnect_sequence_push_supplier);
...
oe_get_interface() -> 
	...
	{"disconnect_sequence_push_supplier", 'CosNotifyComm_SequencePushSupplier':oe_tc(disconnect_sequence_push_supplier)},
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/SequenceProxyPushSupplier:1.0", Env, RegName).
...
%%   Raises:  CosEventChannelAdmin::AlreadyConnected, CosEventChannelAdmin::TypeError
%%
handle_call({OE_THIS, OE_Context, connect_sequence_push_consumer, [Push_consumer]}, OE_From, OE_State) ->
  corba:handle_call('PusherSupplier_impl', connect_sequence_push_consumer, [Push_consumer], OE_State, OE_Context, OE_THIS, OE_From);
...
%%   Returns: RetVal
%%
handle_call({OE_THIS, OE_Context, disconnect_sequence_push_supplier, []}, OE_From, OE_State) ->
  corba:handle_call('PusherSupplier_impl', disconnect_sequence_push_supplier, [], OE_State, OE_Context, OE_THIS, OE_From);
