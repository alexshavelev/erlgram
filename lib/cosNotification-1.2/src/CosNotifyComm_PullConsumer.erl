...
-module('CosNotifyComm_PullConsumer').
-ic_compiled("4_4").
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PullConsumer:1.0", Env, RegName).
...
%% Call to implementation init
    corba:handle_init('CosNotifyComm_PullConsumer_impl', Env).

terminate(Reason, State) ->
    corba:handle_terminate('CosNotifyComm_PullConsumer_impl', Reason, State).
...
handle_call({_, OE_Context, offer_change, [Added, Removed]}, _, OE_State) ->
  corba:handle_call('CosNotifyComm_PullConsumer_impl', offer_change, [Added, Removed], OE_State, OE_Context, false, false);
...
handle_call({_, OE_Context, disconnect_pull_consumer, []}, _, OE_State) ->
  corba:handle_call('CosNotifyComm_PullConsumer_impl', disconnect_pull_consumer, [], OE_State, OE_Context, false, false);
...
code_change(OldVsn, State, Extra) ->
    corba:handle_code_change('CosNotifyComm_PullConsumer_impl', OldVsn, State, Extra).
