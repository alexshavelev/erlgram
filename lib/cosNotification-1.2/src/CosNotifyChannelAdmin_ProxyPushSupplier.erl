...
-module('CosNotifyChannelAdmin_ProxyPushSupplier').
-ic_compiled("4_4").


%% Interface functions
-export([connect_any_push_consumer/2, connect_any_push_consumer/3, suspend_connection/1]).
...
%% Exports from "CosNotifyComm::PushSupplier"
...
%%%% Operation: connect_any_push_consumer
%% 
%%   Returns: RetVal
%%   Raises:  CosEventChannelAdmin::AlreadyConnected, CosEventChannelAdmin::TypeError
%%
connect_any_push_consumer(OE_THIS, Push_consumer) ->
    corba:call(OE_THIS, connect_any_push_consumer, [Push_consumer], ?MODULE).

connect_any_push_consumer(OE_THIS, OE_Options, Push_consumer) ->
    corba:call(OE_THIS, connect_any_push_consumer, [Push_consumer], ?MODULE, OE_Options).
...
%%
%%------------------------------------------------------------
oe_is_a("IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0") -> true;
...
oe_is_a("IDL:omg.org/CosNotifyComm/PushSupplier:1.0") -> true;
...
%%
%%------------------------------------------------------------
oe_tc(connect_any_push_consumer) -> 
...
oe_get_interface() -> 
	...
	{"connect_any_push_consumer", oe_tc(connect_any_push_consumer)}].
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0", Env, RegName).
...
%%   Raises:  CosEventChannelAdmin::AlreadyConnected, CosEventChannelAdmin::TypeError
%%
handle_call({OE_THIS, OE_Context, connect_any_push_consumer, [Push_consumer]}, OE_From, OE_State) ->
  corba:handle_call('PusherSupplier_impl', connect_any_push_consumer, [Push_consumer], OE_State, OE_Context, OE_THIS, OE_From);
...
handle_call({OE_THIS, OE_Context, disconnect_push_supplier, []}, OE_From, OE_State) ->
  corba:handle_call('PusherSupplier_impl', disconnect_push_supplier, [], OE_State, OE_Context, OE_THIS, OE_From);
...
handle_call({OE_THIS, OE_Context, connect_push_consumer, [Push_consumer]}, OE_From, OE_State) ->
  corba:handle_call('PusherSupplier_impl', connect_push_consumer, [Push_consumer], OE_State, OE_Context, OE_THIS, OE_From);
