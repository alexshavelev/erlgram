...
-module('CosNotifyChannelAdmin_StructuredProxyPullSupplier').
-ic_compiled("4_4").


%% Interface functions
-export([connect_structured_pull_consumer/2, connect_structured_pull_consumer/3]).
...
%%
connect_structured_pull_consumer(OE_THIS, Pull_consumer) ->
    corba:call(OE_THIS, connect_structured_pull_consumer, [Pull_consumer], ?MODULE).

connect_structured_pull_consumer(OE_THIS, OE_Options, Pull_consumer) ->
    corba:call(OE_THIS, connect_structured_pull_consumer, [Pull_consumer], ?MODULE, OE_Options).
...
%%
%%------------------------------------------------------------
oe_is_a("IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0") -> true;
...
oe_tc(connect_structured_pull_consumer) -> 
	{tk_void,[{tk_objref,"IDL:omg.org/CosNotifyComm/StructuredPullConsumer:1.0",
...
oe_tc(pull_structured_event) -> 'CosNotifyComm_StructuredPullSupplier':oe_tc(pull_structured_event);
oe_tc(try_pull_structured_event) -> 'CosNotifyComm_StructuredPullSupplier':oe_tc(try_pull_structured_event);
oe_tc(disconnect_structured_pull_supplier) -> 'CosNotifyComm_StructuredPullSupplier':oe_tc(disconnect_structured_pull_supplier);
...
oe_get_interface() -> 
	...
	{"disconnect_structured_pull_supplier", 'CosNotifyComm_StructuredPullSupplier':oe_tc(disconnect_structured_pull_supplier)},
	{"try_pull_structured_event", 'CosNotifyComm_StructuredPullSupplier':oe_tc(try_pull_structured_event)},
	{"pull_structured_event", 'CosNotifyComm_StructuredPullSupplier':oe_tc(pull_structured_event)},
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0", Env, RegName).
...
%%   Raises:  CosEventChannelAdmin::AlreadyConnected
%%
handle_call({OE_THIS, OE_Context, connect_structured_pull_consumer, [Pull_consumer]}, OE_From, OE_State) ->
  corba:handle_call('PullerSupplier_impl', connect_structured_pull_consumer, [Pull_consumer], OE_State, OE_Context, OE_THIS, OE_From);
...
%%   Raises:  CosEventComm::Disconnected
%%
handle_call({OE_THIS, OE_Context, pull_structured_event, []}, OE_From, OE_State) ->
  corba:handle_call('PullerSupplier_impl', pull_structured_event, [], OE_State, OE_Context, OE_THIS, OE_From);
...
%%   Raises:  CosEventComm::Disconnected
%%
handle_call({OE_THIS, OE_Context, try_pull_structured_event, []}, OE_From, OE_State) ->
  corba:handle_call('PullerSupplier_impl', try_pull_structured_event, [], OE_State, OE_Context, OE_THIS, OE_From);

%%%% Operation: disconnect_structured_pull_supplier
%% 
%%   Returns: RetVal
%%
handle_call({OE_THIS, OE_Context, disconnect_structured_pull_supplier, []}, OE_From, OE_State) ->
  corba:handle_call('PullerSupplier_impl', disconnect_structured_pull_supplier, [], OE_State, OE_Context, OE_THIS, OE_From);
