...
-module('CosNotifyComm_PushSupplier').
-ic_compiled("4_4").
...
oe_create() ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0").

oe_create_link() ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0").

oe_create(Env) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0", Env).

oe_create_link(Env) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0", Env).

oe_create(Env, RegName) ->
    corba:create(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0", Env, RegName).

oe_create_link(Env, RegName) ->
    corba:create_link(?MODULE, "IDL:omg.org/CosNotifyComm/PushSupplier:1.0", Env, RegName).
...
%% Call to implementation init
    corba:handle_init('CosNotifyComm_PushSupplier_impl', Env).

terminate(Reason, State) ->
    corba:handle_terminate('CosNotifyComm_PushSupplier_impl', Reason, State).
...
handle_call({_, OE_Context, subscription_change, [Added, Removed]}, _, OE_State) ->
  corba:handle_call('CosNotifyComm_PushSupplier_impl', subscription_change, [Added, Removed], OE_State, OE_Context, false, false);
...
handle_call({_, OE_Context, disconnect_push_supplier, []}, _, OE_State) ->
  corba:handle_call('CosNotifyComm_PushSupplier_impl', disconnect_push_supplier, [], OE_State, OE_Context, false, false);
...
code_change(OldVsn, State, Extra) ->
    corba:handle_code_change('CosNotifyComm_PushSupplier_impl', OldVsn, State, Extra).
